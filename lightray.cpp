    ...
    ui(new Ui::lightRay)
{
    ...
    ////light2
    QGraphicsLineItem* lightRay2 = new QGraphicsLineItem(900, 0, width(), height());
    ...
    ////light7
    QGraphicsLineItem* lightRay7 = new QGraphicsLineItem(0, 360, width(), height());
    lightRay7->setPen(QPen(QColor(0,128,0), 24));
    scene->addItem(lightRay7);

    qreal angle7 = qDegreesToRadians((double)-50);
